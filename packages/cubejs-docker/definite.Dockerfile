...
COPY packages/cubejs-redis-cache-driver/package.json packages/cubejs-redis-cache-driver/package.json
...
COPY packages/cubejs-redis-cache-driver/ packages/cubejs-redis-cache-driver/
